...
def approved_mail_both(apt):
    ...
    message = "Your appointment has been approved by the provider, use this link to enter the meeting:" + zoom.generate_zoom(request=1)
    send_mail(
        subject,
        message,
        email_info.EMAIL_HOST_USER,
    ...
    print(zoom.generate_zoom(request=1))
